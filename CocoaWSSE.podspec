#
#  Be sure to run `pod spec lint CocoaWSSE.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "laiso" => "laiso@lai.so", "other author" => "email@address.com" }
  # s.author       = 'laiso', 'other author'
